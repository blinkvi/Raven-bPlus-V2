...
@Mixin(Entity.class)
public abstract class MIxinNiggerErr {
    @Shadow
    ...
    public void moveEntity(double p_moveEntity_1_, double p_moveEntity_3_, double p_moveEntity_5_) {
        if (this.noClip) {
            ...
            if (((Object) this == mc.thePlayer) && mc.thePlayer.onGround) {
            	SafeWalk safeWalk = (SafeWalk) Raven.moduleManager.getModuleByClazz(SafeWalk.class);
                ...
                if ((safeWalk != null) && safeWalk.isEnabled() && !safeWalk.doShift.isToggled()) {
                    ...
                    if (safeWalk.lookDown.isToggled()) {
                        if ((mc.thePlayer.rotationPitch < safeWalk.pitchRange.getInputMin()) || (mc.thePlayer.rotationPitch > safeWalk.pitchRange.getInputMax())) {
                            flag = mc.thePlayer.isSneaking();
                        }
                    }

                    if(safeWalk.onlyBackwars.isToggled()) {
            ...
            for (Iterator<AxisAlignedBB> var22 = list1.iterator(); var22.hasNext(); p_moveEntity_3_ = axisalignedbb1
            ...
            if ((this.stepHeight > 0.0F) && flag1 && ((d3 != p_moveEntity_1_) || (d5 != p_moveEntity_5_))) {
                ...
                for (Iterator<AxisAlignedBB> var35 = list.iterator(); var35
                ...
                for (Iterator<AxisAlignedBB> var37 = list.iterator(); var37
                ...
                for (Iterator<AxisAlignedBB> var39 = list.iterator(); var39
                ...
                for (Iterator<AxisAlignedBB> var42 = list.iterator(); var42
                ...
                for (Iterator<AxisAlignedBB> var44 = list.iterator(); var44
                ...
                for (Iterator<AxisAlignedBB> var46 = list.iterator(); var46
                ...
                for (Iterator<AxisAlignedBB> var50 = list.iterator(); var50.hasNext(); p_moveEntity_3_ = axisalignedbb12
                        .calculateYOffset(this.getEntityBoundingBox(), p_moveEntity_3_)) {
